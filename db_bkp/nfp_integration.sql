...
--
alter table `lr_voluntario` drop foreign key `fk_vol_user_1`;
alter table `lr_voluntario` drop foreign key `fk_vol_nucleo_2` ;
alter table `lr_voluntario` drop foreign key `fk_vol_ent_3`;
alter table `lr_voluntario` drop foreign key `fk_vol_tp_vol_4` ;

alter table `lr_rel_acesso_usuario_tela` drop foreign key `lr_rel_acesso_usuario_tela_ibfk_1`;
alter table `lr_rel_acesso_usuario_tela` drop foreign key `lr_rel_acesso_usuario_tela_ibfk_2`;

alter table `lr_nota` drop foreign key `fk_nota_emp_1`;
alter table `lr_nota` drop foreign key `fk_nota_vol_2`;
alter table `lr_nota` drop foreign key `fk_nota_status_3`;
