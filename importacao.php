...
<script type="text/javascript">
  ...
  function ajaxFileUpload(self) {
    ...
    var sender = 'importacaoArquivoNota';
...
<div id="form" class="">
  <form id="importacao" name="importacao" action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="field action">
      <div class="field"><button type="submit" id="enviar" name="enviar" value="save" onclick="return ajaxFileUpload(this);"><span class="icon"></span>Salvar</button></div>
    </div>
  </form>
</div>